...
ParticleFilter::ParticleFilter(MarkovProcess& system,
...
void ParticleFilter::reset(const Particles& particles) {
  m_belief = particles;
  m_first_pass = true;
}

const Particles& ParticleFilter::getBelief() const {
  return m_belief;
}

const Particles& ParticleFilter::estimate(const Eigen::VectorXd& observation,
...
const Particles& ParticleFilter::predict(const Eigen::VectorXd& control) {
...
const Particles& ParticleFilter::correct(const Eigen::VectorXd& observation) {
...
void ParticleFilter::systematicResampling(Eigen::VectorXd& wp,
                                          Eigen::MatrixXd& xp) const {
...
void ParticleFilter::roughenParticles(Eigen::MatrixXd& xp) const {
